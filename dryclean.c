...
int main(void) {
  ...
  infile = fopen("dryclean.in", "r");
  outfile = fopen("dryclean.out", "w");
...
void depart1(void) {
  ...
  if (list_size[LIST_S2] == 0) { // is server 2 idle ?
...
void depart2(void) /* Departure event from service of server 2 */
{
